...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($validationFailed){
        ...
        if ($conn->connect_error) {
            ...
            echo "Connection to DB created...";
        }


        $stmt = $conn->prepare("INSERT INTO skilehrer (firstName, lastName, mobile, email, street, houseNumber, zipCode, city, level, canSki, canSnowboard, iban, birthDate, comment)
                    VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
