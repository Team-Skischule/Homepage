        ...
        <div class="row">
            ...
            <form class="content-container" id="form2" action="" name="contact" >
                <h2>Mitarbeiter bearbeiten formular</h2>
                    ...
                    <div class="form-group row">
                        <label for="formVorname" class="col-sm-4 col-form-label vorname1">Vorname* </label>
                        <input type="text" class="form-control col-sm-8" name="formVorname" id="formVornameSkilehrer" value="" required>
                    </div>

                    <div class="form-group row">
                        <label for="formNachname" class="col-sm-4 col-form-label">Nachname*</label>
                        <input type="text" value="" class="form-control col-sm-8" name="formNachname" id="formNachnameSkilehrer" minlength="1" required>
                    </div>

                    <div class="form-group row">
                        <label for="formMobil" class="col-sm-4 col-form-label">Telefon*</label>
                        <input type="tel" name="phone" id="phoneSkilehrer" class="form-control col-sm-8" placeholder="+1234567890" minlength="5" required>
                    </div>

                    <div class="form-group row">
                        <label for="formEmail" class="col-sm-4 col-form-label">Email*</label>
                        <input type="email" class="form-control col-sm-8" name="formEmail" id="formEmailSkilehrer" placeholder="test@tester.at" required>
                    </div>

                    <div class="form-group row">
                        <label for="formGeburtsdatum" class="col-sm-4 col-form-label">Geburtsdatum*</label>
                        <input type="date" class="form-control col-sm-8" name="formGeburtsdatum" id="formGeburtsdatumSkilehrer" required>
                    </div>

                    <div class="form-group row">
                        <!-- formLevel umbenannt auf skilevel -->
                        <label for="formSkiLevel" class="col-sm-4 col-form-label">Ski-Level* </label>
                        <select class="form-control col-sm-8" name="formSkiLevel" id="formSkiLevelSkilehrer" placeholder="Bitte wählen">
                            <option value="0">Keine</option>
                            <option value="1">Anwärter</option>
                            <option value="2">Landes</option>
                            <option value="3">Staatlicher</option>
                    ...
                    <div class="form-group row">
                        <label for="formSnowboardLevel" class="col-sm-4 col-form-label">Snowboard-Level* </label>
                        <select class="form-control col-sm-8" name="formSnowboardLevel" id="formSnowboardLevelSkilehrer" placeholder="Bitte wählen">
                            <option value="0">Keine</option>
                            <option value="1">Anwärter</option>
                            <option value="2">Landes</option>
                            <option value="3">Staatlicher</option>
